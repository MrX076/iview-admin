...
export const appRouter = [
    ...
    //         { path: 'table2image', title: '表格转图片', name: 'table-to-image',access: 'ROLE_ADMIN', icon: 'images', component: () => import('@/views/tables/editable-table.vue') }
    //     ]
    // },
    {
        path: '/biz',
        ...
        children: [
            ...
            { path: 'examineMnt', title: '审核', name: 'examine-mnt', icon: 'search', component: () => import('@/views/biz-mgt/verify.vue') },
            // { path: 'exportableTable', title: '表格导出数据', name: 'exportable-table', icon: 'code-download', component: () => import('@/views/tables/exportable-table.vue') },
